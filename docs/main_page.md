...
![images/RF24EthernetOverviewImg.jpg](images/RF24EthernetOverviewImg.jpg){width=70% height=70%}
...
## News
2026: RF24Ethernet now supports the lwIP stack! Most devices with >=50MHz processors will automatically use the lwIP stack.
